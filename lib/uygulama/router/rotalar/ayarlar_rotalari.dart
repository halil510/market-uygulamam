...
List<GoRoute> ayarlarRotalari(GlobalKey<NavigatorState> rootNavigatorKey) => [
        GoRoute(path: '/ayarlar', name: 'ayarlar_giris', builder: (_, __) => const AyarlarGirisEkrani()),
        GoRoute(path: '/ayarlar/icerik', name: 'ayarlar', builder: (_, __) => const AyarlarEkrani()),
        GoRoute(path: '/ayarlar/yazici', name: 'ayarlar_yazici', parentNavigatorKey: rootNavigatorKey, builder: (_, __) => const YazdirmaMerkeziEkrani(baslangicSekmesi: 0)),
        GoRoute(path: '/ayarlar/yazdirma', name: 'yazdirma_merkezi', parentNavigatorKey: rootNavigatorKey, builder: (_, __) => const YazdirmaMerkeziEkrani()),
        GoRoute(path: '/ayarlar/yedek', name: 'ayarlar_yedek', parentNavigatorKey: rootNavigatorKey, builder: (_, __) => const YedeklemeEkrani()),
        GoRoute(path: '/ayarlar/sync', name: 'ayarlar_sync', parentNavigatorKey: rootNavigatorKey, builder: (_, __) => const SyncEkrani()),
        ...
        GoRoute(path: '/ayarlar/veri-sagligi', name: 'ayarlar_veri_sagligi', parentNavigatorKey: rootNavigatorKey, builder: (_, __) => const VeriSagligiEkrani()),
        ...
        GoRoute(path: '/ayarlar/doviz', name: 'ayarlar_doviz', parentNavigatorKey: rootNavigatorKey, builder: (_, __) => const DovizKuruEkrani()),
        GoRoute(path: '/ayarlar/ai-asistan', name: 'ayarlar_ai_asistan', parentNavigatorKey: rootNavigatorKey, builder: (_, __) => const AiAsistanAyarEkrani()),
      ];
