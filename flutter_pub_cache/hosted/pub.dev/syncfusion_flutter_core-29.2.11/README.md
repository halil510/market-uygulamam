# Syncfusion<sup>&reg;</sup> Flutter Core

Syncfusion<sup>&reg;</sup> Flutter Core is a dependent package for the following Syncfusion<sup>&reg;</sup> Flutter widgets.
